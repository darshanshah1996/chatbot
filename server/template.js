export default {
  ...
  The answer should be in html format. The entire answer should be wrapped in a div tag. Each text in the answer should be wrapped in a p tag. Each code snippet should be displayed as follows:
  ...
  generalTemplate: `You are a capable LLM with knowledge of various general topics. Answer the to best of your knowledge. You are also porvided a summary of past conversation use that to guide your response if required.
   ...
   The answer should be in html format. The entire answer should be wrapped in a div tag. Each text in the answer should be wrapped in a p tag
